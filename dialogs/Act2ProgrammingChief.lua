...
return {
	FirstTime = function()
		...
		Tux:says(_"Isn't it strange? I mean, a linarian?")
		Npc:says(_"[b]*chuckles*[/b] No, not at all. When your president is a linarian, it's hard to miss one.", "NO_WAIT")
		Tux:says(_"President?")
		Npc:says(_"He owned MegaSystem. He kept his face hidden all the time, but I'm sure he was a Linarian.", "NO_WAIT")
...

	{
		...
		code = function()
			...
			Npc:says(_"No, I can't. He would just kill me remotely, and I would rather stay alive.")
			Tux:says(_"Which remembers, why are you alive, if everyone else is dead?")
			Npc:says(_"Thankfully the president thinks I'm needed alive if anything goes wrong with this facility. Which means I can't leave it as well.")
	...
	},
	{
		...
		code = function()
				if (Tux:train_skill(10000, 1, "programming")) then -- Not much AP because Tux probably is a high-level linarian by now.
					...
					Npc:says(_"Once you understand how the bytes flows, how they sum and they bitwise, how they explode one each other on a Tachyon Condensator making the bot alive, you'll become a true programming master.")
					Tux:says(_"What should I do?")
					Npc:says(_"Now, look at source code, and replicate the ping pong, but not with the simple AI I included. I want a sencient ping pong field, with air friction, gravity, virtual reality, I want also to you consider the solar effect over tachyon particles and the E-particle emission on field due to atrict with two antigrav rackets.")
					...
					Npc:says(_"By the way, you've learnt very fast the tachyon partial overflow when the bytes exploded on Stage 7. You have an unnatural talent to it, even bigger than MS President. Did you sold your soul by any chance?")
