...
--[[WIKI
PERSONALITY = { "Robotic" },
BACKSTORY = "$$NAME$$ was part of Act 2. He guards the portal to the recption desk."
WIKI]]--
...
return {
	FirstTime = function()
		...
		Npc:says(_"There is also 614 security droid.")
...

	{
		...
		code = function()
			...
			Npc:says(_"I know. But Jim doesn't fear of that... He hates bots and wants to destroy them all.")
			Tux:says(_"What's wrong with him? Is he crazy?")
			Npc:says(_"No... That's a bad story...")
			Npc:says(_"Spencer, the leader of Red Guard, sent a group of soldiers to scout the area, but not one of them came back.")
	...
	},
	{
		...
		code = function()
			...
			Npc:says(_"Good idea, but I don't need any help... Wait! My 614... It's power level is too low. I think that soon it will turn off.")
	...
	},
	{
		...
		code = function()
			...
			Npc:says(_"Here is my award for you. When we saw this place at the first time, we found some bot inside. I destroyed it and an this mace dropped out of it. I'm not sure how did it appear inside, but now it's yours.")
			Tux:add_item("Mace")
	...
	},
	{
		...
		code = function()
			...
			Tux:says(_"Yuck! I hope that you are not meeting all guests like that.")
