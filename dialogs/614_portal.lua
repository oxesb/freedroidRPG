...
PERSONALITY = { "Robotic" },
MARKERS = {  },
BACKSTORY = "$$NAME$$ is part of Act 2. He is a 614 droid guarding the Portal."
WIKI]]--
...
return 
{
	...
	},
	{
		...
		code = function()
			...
			Npc:says(_"...")
			Npc:says(_"...")
			Npc:says(_"ERROR! Similiar command not found! Using random alternative.")
			Tux:says(_"OUCH!")
			freeze_tux(7)
			hide("node4")
			end_dialog()
	...
	},
	{
		...
		code = function()
			Npc:says(_"My orders are to protect survivors from hostile bots.")
