...
void leveleditor_display(void)
{
	AssembleCombatPicture(ONLY_SHOW_MAP_AND_TEXT | SHOW_ITEMS | OMIT_TUX |
	                      ...
	                      GameConfig.omit_enemies_in_level_editor * OMIT_ENEMIES |
						  GameConfig.zoom_is_on * ZOOM_OUT | OMIT_BLASTS | SKIP_LIGHT_RADIUS |
						  NO_CURSOR | OMIT_ITEMS_LABEL | !GameConfig.zoom_is_on * SHOW_OBSTACLE_LABELS);
