...
void next_startup_percentage(int);
...
void event_position_changed(gps, int);
...
float GetInfluPositionHistoryX(int);
float GetInfluPositionHistoryY(int);
float GetInfluPositionHistoryZ(int);
...
void sign_read_action(level *, int);
...
int resolve_virtual_position(gps *, gps *);
...
void make_texture_out_of_surface(struct image *);
...
void blast_obstacle(level *, obstacle *);
...
void translate_map_point_to_screen_pixel_func(float, float, int *, int *);
...
int way_free_of_droids(float, float, float, float, int, freeway_context *);
...
int ItemCanBeDroppedInInv(item_t, int, int);
...
item *DropItemAt(item_t, int, float, float, int);
...
int GetInventorySquare_x(int);
int GetInventorySquare_y(int);
...
struct addon_spec *get_addon_spec(item_t);
...
int mouse_cursor_is_on_that_image(float, float, struct image *);
...
int MyRandom(int);
void Teleport(int, float, float, int, int);
...
void load_image_surface(struct image *, const char *, int);
...
void move_obstacle(obstacle *, float, float);
