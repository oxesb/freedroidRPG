...
return {
	...
	},
	{
		...
		code = function()
			...
			Npc:says(_"While you were away, we found info about an interesting place in the databanks. There's a cryonic facility which MS used to dispose... undesirable individuals. Well, it's very far away, but we also found a treasure which makes this unimportant.")
