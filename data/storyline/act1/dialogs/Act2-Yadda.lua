...
PURPOSE = "$$NAME$$ is a strange monk who follows the path of light. Options become available as you talk to him. Gives quest to slay evil viruses. Give quests for Source Book of Light, Light Saber and Light Staff. Sells player Laser Power Pack and small plasma grenades. Is a pacifist with a weak resolve, thus why he sells Tux grenades etc. May summon droids to help Tux in certain quests, or to kill tux if he appears to be walking on an evil path, be it because bad karma, or because strange items on his possession."
WIKI]]--
...
return {
	...
	},
	{
		...
		code = function()
			...
			Npc:says(_"...And %d VMX Gas Grenades. I'm a pacifist, but the disciples of dark - robots and viruses - wishes my life. Only with gas grenades I shall survive. They're poison to mere mortals, but for the great master Yadda, they are source of life.", Yadda_vmx_saber)
			--; TRANSLATORS: %d = number of VMX grenades required to craft the Light Saber. Varies according to difficulty.
			Tux:says(_"I have no idea of how life can come out from gas grenades, but I shall bring you 5.000 circs, 3 source books of light, and %d VMX grenades.", Yadda_vmx_saber)
			show("buysaber")
		end,
	},
	{
	...
	},
	{
		...
		code = function()
			...
			Npc:says(_"There is also the [b]011 Grenadier[/b]. He'll throw grenades to destroy your army. Mass destruction. Kill it as fast as you can.")
			...
			Npc:says(_"Ha! Not even the start. Agent Zero did many tests on this area to create the supreme foe. There is the graveyard series: [b]Zombot[/b] and you won't want to know what it does, the [b]Ghost[/b] or [b]Shadow Hunter[/b], it uses invisibility so very dangerous.", "NO_WAIT")
	...
	},
	{
		...
		code = function()
			...
			--; TRANSLATORS: Komm und hilf mir → Come and aid me (from German)
